...
class Applicant(models.Model):
    ...
    majorProgram = models.CharField(max_length=20, default='')
    majorProgramInterest = models.CharField(max_length=20, default='')
    optionalProgram= models.CharField(max_length=20, default='')
    optionalProgramInterest = models.CharField(max_length=20, default='')
    ...
    hearAboutother = models.CharField(max_length=20, blank=True, null=True)
